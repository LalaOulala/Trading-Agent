...
def build_trading_agent(model_name: str | None = None) -> Agent:
    ...
    instructions = (
        ...
        "Hygiène des arguments tools (obligatoire):\n"
        "- Les symboles doivent être stricts (ex: SPY, AAPL, IYH), sans préfixe ':', sans fragments de "
        "tool-call, sans caractères parasites.\n"
        "- Si un argument semble corrompu, corrige-le avant d'appeler le tool.\n\n"
